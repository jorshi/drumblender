...
from kick2kick.models import KickTCN
from kick2kick.models import TCN
...
def test_tcn_uses_gated_activation(mocker):
    ...
    import kick2kick.models.tcn

    spy = mocker.spy(kick2kick.models.tcn.GatedActivation, "__call__")
...
def test_tcn_can_use_norm_layers(mocker, norm, cls_string):
    ...
    spy = mocker.spy(kick2kick.models.tcn.nn, cls_string)
    ...
    spy = mocker.spy(getattr(kick2kick.models.tcn.nn, cls_string), "__call__")
...
def test_can_use_tfilm_in_tcn(mocker):
    ...
    spy = mocker.spy(kick2kick.models.tcn, "TFiLM")
    ...
    spy = mocker.spy(kick2kick.models.tcn.TFiLM, "__call__")
    x = torch.testing.make_tensor(
        batch_size, in_channels, seq_len, device="cpu", dtype=torch.float32
    )
    _ = tcn(x)
...
def test_kick_tcn_correctly_forwards_input(mocker):
    ...
    spy = mocker.spy(kick2kick.models.tcn.TCN, "__call__")
